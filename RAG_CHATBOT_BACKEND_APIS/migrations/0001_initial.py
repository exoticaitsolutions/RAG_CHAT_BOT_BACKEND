    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flag', models.BooleanField(default=True)),
                ('wikiDataId', models.CharField(blank=True, help_text='Rapid API GeoDB Cities', max_length=255, null=True)),
                ('region', models.ForeignKey(db_column='region_id', on_delete=django.db.models.deletion.CASCADE, to='RAG_CHATBOT_BACKEND_APIS.region')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('profile_pic', models.FileField(blank=True, default='default_images/user_profile_pic.jpg', max_length=250, upload_to='profile_pic/')),
                ...
                ('user_upload_dir', models.TextField(blank=True, default='')),
                ('user_upload_path', models.TextField(blank=True, default='')),
                ('user_chroma_db_dir', models.TextField(blank=True, default='')),
