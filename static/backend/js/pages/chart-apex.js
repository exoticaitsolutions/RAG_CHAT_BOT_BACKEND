...
setTimeout(function () {
  ...
  (function () {
    var options = {
      ...
      colors: ['#8d54a2', '#2CA87F', '#E58A00', '#13c2c2'],
      responsive: [
        {
          breakpoint: 480,
          options: {
  ...
  (function () {
    var options = {
      ...
      colors: ['#8d54a2', '#13c2c2', '#2CA87F', '#E58A00', '#DC2626'],
      stroke: {
        width: 1,
        colors: ['#fff']
      },
  ...
  (function () {
    ...
    var options = {
      ...
      colors: ['#8d54a2', '#2CA87F', '#E58A00', '#DC2626'],
      fill: {
        opacity: 0.8
      },
      xaxis: {
  ...
  (function () {
    var options = {
      ...
      colors: ['#8d54a2', '#2CA87F', '#DC2626', '#E58A00', '#13c2c2'],
      series: [
        {
          name: 'SAMPLE A',
          data: [
  ...
  (function () {
    var options = {
      ...
      colors: ['#8d54a2', '#2CA87F', '#13c2c2', '#E58A00', '#DC2626'],
      legend: {
        show: true,
        position: 'bottom'
      },
