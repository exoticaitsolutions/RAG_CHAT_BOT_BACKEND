...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (control) {
      if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
        document.querySelector(".pc-sidebar .m-header .logo-lg").setAttribute('src', '../assets/images/ai_logo.png');
      }
      if (document.querySelector('.auth-header')) {
        document.querySelector(".auth-header img").setAttribute('src', '../assets/images/ai_logo.png');
      }
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
